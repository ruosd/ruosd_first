...
class QuestionRewriter:
    ...
    def _is_already_formal(self, question: str) -> bool:
        ...
        return any(re.search(pattern, question) for pattern in formal_patterns)
    ...
    async def rewrite(self, question: str, conversation_history: list | None = None) -> str:
        """
        重写用户问题，使其更专业、更清晰
