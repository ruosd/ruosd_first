...
class Message(BaseModel):
    ...
    agent_name: Optional[str] = Field(None, max_length=64, description="处理消息的Agent名称")
...
class ConversationCreate(BaseModel):
    ...
    title: Optional[str] = Field(None, max_length=128, description="对话标题")
    metadata: Optional[Dict] = Field(default_factory=dict, description="对话元数据")
...
class ConversationUpdate(BaseModel):
    ...
    metadata: Optional[Dict] = Field(None, description="对话元数据")
